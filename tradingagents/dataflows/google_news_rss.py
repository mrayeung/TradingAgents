...
Raises GoogleNewsUnavailableError (a VendorError) on failure so interface.py
cascades to the next vendor (yfinance) without interrupting the agent pipeline.
"""
...
class GoogleNewsUnavailableError(VendorError):
...
def get_global_news_google_rss(
    ...
    Args:
        ...
        look_back_days: Days to look back (default 7).
