    ...
    for vendor in vendor_chain:
        ...
        try:
            return impl_func(*args, **kwargs)
                ...
                GoogleNewsUnavailableError, StockTwitsUnavailableError,
                SECEdgarUnavailableError, VendorRateLimitError):
            logger.warning("Vendor %r rate-limited or unavailable for %s; trying next vendor.", vendor, method)
            continue
